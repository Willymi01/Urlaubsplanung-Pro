const CACHE='urlaubsplaner-v2.1';
const ASSETS=['./','./index.html','./style.css?v=2.1','./data.js?v=2.1','./app.js?v=2.1','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
