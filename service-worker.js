const CACHE='urlaubsplaner-v2.3';
const ASSETS=['./','./index.html','./style.css?v=2.2','./data.js?v=2.2','./app.js?v=2.2','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
