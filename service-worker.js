const CACHE='urlaubsplaner-v1.9';
const ASSETS=['./','./index.html','./style.css?v=1.9','./data.js?v=1.9','./app.js?v=1.9','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
