...
function moveForVacation(v){return [...(state.moves||[])].reverse().find(m=>Number(m.vacationId)===Number(v.id)||(Number(m.employeeId)===Number(v.employeeId)&&m.newPeriod===period(v.from,v.to)))}
